...
public class Program
{
    ...
    private static readonly ConcurrentBag<double> _queryDurations = [];
    ...
    public static void SessionExample(ILoggerWrapper logger, ITrinoAuth auth, Uri serverUri)
    {
        ...
        Equals(connection.ConnectionSession.Properties.Source, properties.Source);
